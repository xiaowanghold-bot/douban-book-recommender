...
axes[1].set_title("Log Votes Distribution")
axes[1].legend()
...
ax.legend()
plt.colorbar(sc, ax=ax, label="Log Votes")
...
ax.invert_yaxis()
ax.set_xlabel("Score * Log(Votes)")
ax.set_title("Top 20 Books")
...
ax.set_xlabel("Votes Tier")
ax.set_ylabel("Books")
ax.set_title("Votes Tier Distribution")
